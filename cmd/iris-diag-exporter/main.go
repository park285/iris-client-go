...
var metricKeyAllowlist = map[string]struct{}{
	...
	"iris_workers_webhook_dead_reasons_missing_endpoint":      {},
	"iris_workers_webhook_dead_reasons_transport_security":    {},
	"iris_workers_webhook_dead_reasons_non_retriable_status":  {},
	"iris_workers_webhook_dead_reasons_terminal_transport":    {},
	"iris_workers_webhook_dead_reasons_retry_exhausted":       {},
	"iris_workers_webhook_dead_reasons_retry_horizon_expired": {},
