...
레코드 3건: proposed 0, accepted 2, rejected 0, withdrawn 0, superseded 1

| ID | 제목 | 결정 상태 | 이행 상태 | scope | 결정일 | 재검토 | 대체 관계 | 원본 |
|---|---|---|---|---|---|---|---|---|
| [DEC-20260906-sdk-typed-json-response-budget](records/DEC-20260906-sdk-typed-json-response-budget.json) | SDK typed JSON 응답은 압축 해제 후 16 MiB로 제한하고 초과 POST의 결과 불명을 보존한다 | accepted | verified | iris-client-go | 2026-09-06 | - | - | - |
