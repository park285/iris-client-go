...
| **C** | [`chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-c-retry-backoff-consolidation.md`](../../chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-c-retry-backoff-consolidation.md) | cbgk gemini + memoryqueue retry → shared-go/pkg/backoff 통합 | — | **Plan E** | **On hold** — Plan E 옵션 B(module path 정합화) 적용 후 재개 |
| **E** | [`chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-e-shared-go-publish-path.md`](../../chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-e-shared-go-publish-path.md) | shared-go publish path 정의 (Plan C STOP의 follow-up) | Plan C 재개 | — | **In progress** (옵션 B 확정 2026-05-23: module path 정합화) |
...
| **G** | [`iris-client-go/docs/2026-05-22-plan-g-multipart-streaming.md`](./2026-05-22-plan-g-multipart-streaming.md) | multipart streaming alloc-safe 재시도 (Plan A Task 4 split) | — | **Plan A core merge** | **In progress** (2026-05-23 wave 진행 중) |
| **H** | [`hololive-bot/docs/agent-workflows/plans/2026-05-23-plan-h-dispatcher-retry-sentinel-queue.md`](../../hololive-bot/docs/agent-workflows/plans/2026-05-23-plan-h-dispatcher-retry-sentinel-queue.md) | hololive dispatcher queue가 iris sentinel을 인식해 permanent 실패 즉시 FAILED (Plan B Task 4 escalate) | — | Plan B merge | **In progress** (2026-05-23 schema migration 포함 진행 승인됨) |
