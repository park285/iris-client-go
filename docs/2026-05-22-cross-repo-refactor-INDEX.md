...
|---|---|---|---|---|---|
| **A** | [`iris-client-go/docs/2026-05-22-plan-a-error-export-and-march-residuals.md`](./2026-05-22-plan-a-error-export-and-march-residuals.md) | iris-client-go error sentinel + typed export, March P2.1 multipart, P2.6 transport 명확화 | Plan B | — | Draft |
| **B** | [`iris-client-go/docs/2026-05-22-plan-b-consumer-error-migration.md`](./2026-05-22-plan-b-consumer-error-migration.md) | cbgk + hololive에서 새 sentinel 채택, retry 분류 정밀화 | — | **Plan A** | Draft |
| **C** | [`chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-c-retry-backoff-consolidation.md`](../../chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-c-retry-backoff-consolidation.md) | cbgk gemini + memoryqueue retry → shared-go/pkg/backoff 통합 | — | **Plan E** | **On hold** — Task 1.5 BLOCKING gate 발동 (CI 단독 빌드 확정) |
| **E** | [`chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-e-shared-go-publish-path.md`](../../chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-e-shared-go-publish-path.md) | shared-go publish path 정의 (Plan C STOP의 follow-up) | Plan C 재개 | — | Draft |
| **F** | [`chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-f-internal-app-logger-race.md`](../../chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-f-internal-app-logger-race.md) | internal/app logger pre-existing race fix (Plan D Phase 1 final validation에서 발견) | `go test ./... -race` 전체 통과 | — | Draft |
| **G** | [`iris-client-go/docs/2026-05-22-plan-g-multipart-streaming.md`](./2026-05-22-plan-g-multipart-streaming.md) | multipart streaming alloc-safe 재시도 (Plan A Task 4 split) | — | **Plan A core merge** | Draft |
| **H** | [`hololive-bot/docs/agent-workflows/plans/2026-05-23-plan-h-dispatcher-retry-sentinel-queue.md`](../../hololive-bot/docs/agent-workflows/plans/2026-05-23-plan-h-dispatcher-retry-sentinel-queue.md) | hololive dispatcher queue가 iris sentinel을 인식해 permanent 실패 즉시 FAILED (Plan B Task 4 escalate) | — | Plan B merge | Draft |
| **D** | [`chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-d-bot-package-decomposition.md`](../../chat-bot-go-kakao/docs/agent-workflows/plans/2026-05-22-plan-d-bot-package-decomposition.md) | internal/bot 188 파일 단일 패키지 → 7-phase 서브패키지 분해 | — | — | Draft (Phase 1 상세, 2~7 outline) |
